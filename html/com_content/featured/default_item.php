...
$img_src = htmlspecialchars($images->image_intro); 
$img_alt = htmlspecialchars($images->image_intro_alt);
$img_title = htmlspecialchars($images->image_intro_caption);
?>
...
<div class="row">
	<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
        ...
        <div class="img-intro-<?php echo htmlspecialchars($imgfloat); ?> col-md-4"> 
    ...
    <div class="col-md-8">
        ...
        <?php if ($useDefList && ($info == 0 ||  $info == 2)) : ?>
            <section class="article-info  muted">
...
?>
	...
	<p class="readmore">
        <a class="st-readmore" href="<?php echo $link; ?>">
